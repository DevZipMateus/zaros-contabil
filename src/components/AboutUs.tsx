      ...
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="text-center group">
            ...
            <h3 className="text-2xl font-bold font-kassan text-foreground mb-4">Missão</h3>
          ...
          <div className="text-center group">
            ...
            <h3 className="text-2xl font-bold font-kassan text-foreground mb-4">Visão</h3>
            <p className="text-foreground/70 leading-relaxed">
          ...
          <div className="text-center group">
            ...
            <h3 className="text-2xl font-bold font-kassan text-foreground mb-4">Valores</h3>
            <p className="text-foreground/70 leading-relaxed">
